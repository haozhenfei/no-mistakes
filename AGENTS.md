...
- Regressions: `TestLoadTrustedRepoConfig_FailClosedOnFetchFailure`, `TestLoadTrustedRepoConfig_PinnedSHAReadsFreshDefaultBranch`, `TestEffectiveRepoConfig_DocumentPolicyTrustedOnly`, `TestEffectiveRepoConfig_ReviewInstructionsTrustedOnly`, `TestEffectiveRepoConfig_EvidenceUploadCmdIsTrustedOnly`, `TestEffectiveRepoConfig_NoTrustedDisablesEvidenceUploadCmd`, e2e `TestRepoConfigCommandsFromDefaultBranch` (incl. `pushed_branch_cannot_self_enable`).
