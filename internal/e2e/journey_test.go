...
func assertPipelineStepsInOrder(t *testing.T, steps []ipc.StepResultInfo) {
	t.Helper()
	expected := []types.StepName{types.StepIntent, types.StepRebase, types.StepReview, types.StepTest, types.StepQA, types.StepVerify, types.StepDocument, types.StepLint, types.StepPush, types.StepPR, types.StepCI}
